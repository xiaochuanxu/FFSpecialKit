...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/xiaochuanxu/FFSpecialKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'xiaochuanxu' => 'xuxiaochuan@zbj.com' }
  s.source           = { :git => 'https://github.com/xiaochuanxu/FFSpecialKit.git', :tag => s.version.to_s }
